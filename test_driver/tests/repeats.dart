...
Future<void> checkForDefaults(FlutterDriver driver) async {
  ...
  print('scrolling');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_oil'),
      dyScroll: -10.0);
  print('oil found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_tireRotation'),
      dyScroll: -10.0);
  print('rot found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_wiperBlades'),
      dyScroll: -10.0);
  print('wiper found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_alignmentCheck'),
      dyScroll: -10.0);
  print('align found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_cabinFilter'),
      dyScroll: -10.0);
  print('cab found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_engineFilter'),
      dyScroll: -10.0);
  print('eng found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_tires'),
      dyScroll: -10.0);
  print('tire found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_brakes'),
      dyScroll: -10.0);
  print('brak found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_sparkPlugs'),
      dyScroll: -10.0);
  print('spark found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_battery'),
      dyScroll: -10.0);
  print('bat found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_frontStruts'),
      dyScroll: -10.0);
  print('front found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_rearStruts'),
      dyScroll: -10.0);
  print('rear found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_coolantChange'),
      dyScroll: -10.0);
  print('cool found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_transmissionFluid'),
      dyScroll: -10.0);
  print('trans found');
  await driver.scrollUntilVisible(find.byValueKey('__repeat_screen_scroller__'),
      find.byValueKey('__repeat_delete_button_serpentineBelt'),
      dyScroll: -10.0);
  print('belt found');
}
...
Future<void> editRepeat(FlutterDriver driver) async {
  ...
  await driver.scrollUntilVisible(
      find.byValueKey('__repeats_screen_scroller__'),
      find.byValueKey('__repeat_card_edit_testRepeat'),
      dyScroll: 100.0); // our repeat will be above defaults, so scroll up
  print('tapping');
  await driver.tap(find.byValueKey('__repeat_card_edit_testRepeat'));
...
Future<void> deleteRepeat(FlutterDriver driver) async {
  ...
  await driver
      .waitForAbsent(find.byValueKey('__repeat_delete_button_testRepeat'));
}
