...
#     model = Todo
#     sort_fields = ["completed", "dueMileage", "dueDate"]
...
class TodoListView(mixins.LoginRequiredMixin, views.View):
    def get(self, request, *args, **kwargs):
        f = TodoFilter(request.GET, queryset=Todo.objects.filter(owner=request.user))
        return render(request, "autodo/todo_list.html", {"filter": f})
