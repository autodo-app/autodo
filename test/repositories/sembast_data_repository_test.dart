    ...
    group('todos', () {
      ...
      test('batch', () async {
        ...
        expect(
            ...
            SembastWriteBatch(
                dbFactory: repository.dbFactory, dbPath: './sample.db', store: StoreRef('todos')));
      });
    });
    group('refuelings', () {
      final ref = Refueling(
      ...
      test('batch', () async {
        ...
        expect(
            ...
            SembastWriteBatch(
                dbFactory: repository.dbFactory, dbPath: './sample.db', store: StoreRef('refuelings')));
      });
    });
    group('cars', () {
      test('New', () {
      ...
      test('batch', () async {
        ...
        expect(
            ...
            SembastWriteBatch(
                dbFactory: repository.dbFactory, dbPath: './sample.db', store: StoreRef('cars')));
      });
    });
    group('repeats', () {
      test('New', () {
      ...
      test('batch', () async {
        ...
        expect(
            ...
            SembastWriteBatch(
                dbFactory: repository.dbFactory, dbPath: './sample.db', store: StoreRef('repeats')));
      });
    });
  });
}
