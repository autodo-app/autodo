  ...
  group('SembastDataRepository', () {
    ...
    group('todos', () {
      ...
      test('todos', () async {
        ...
        repository = SembastDataRepository(dbPath: 'todos.db');
    ...
    group('refuelings', () {
      ...
      test('refuelings', () async {
        ...
        repository = SembastDataRepository(dbPath: 'refuelings.db');
    ...
    group('cars', () {
      ...
      test('cars', () async {
        ...
        repository = SembastDataRepository(dbPath: 'cars.db');
    ...
    group('repeats', () {
      ...
      test('repeats', () async {
        ...
        repository = SembastDataRepository(dbPath: 'repeats.db');
