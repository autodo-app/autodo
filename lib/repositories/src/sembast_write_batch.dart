...
class SembastWriteBatch extends Equatable implements WriteBatchWrapper {
  ...
  @override
  updateData(id, data) => transactionList.add((txn) => store.record(id).put(txn, data));
  ...
  @override
  List<Object> get props => [store, dbFactory, dbPath];

  @override
  toString() => "SembastWriteBatch { store: $store, database: $dbFactory }";
}
